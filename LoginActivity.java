...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Si había credenciales guardadas, rellenar los EditText para comodidad del usuario
    ...
    private void doLogin() {
        ...
        if (id > 0) {
            // Guardar sesión y credenciales (texto plano) — commit síncrono desde SessionManager
