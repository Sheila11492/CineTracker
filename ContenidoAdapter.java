...
public class ContenidoAdapter extends RecyclerView.Adapter<ContenidoAdapter.ViewHolder> {
    ...
    // Fechas (favorito + seguimiento) en una sola línea/2 líneas

    private void pintarFechas(ViewHolder h, Contenido c) {
        StringBuilder sb = new StringBuilder();

        // Fecha favorito
        Long fechaFav = db.getFechaFavorito(usuarioId, c.getId()); // asegúrate de tener este método en DB
        if (fechaFav != null) {
    ...
    private void abrirDialogoEditar(Contenido c, ViewHolder h) {
        ...
        etGenero.setText(c.getGenero());
        etAnio.setText(String.valueOf(c.getAño()));
        etDuracion.setText(String.valueOf(c.getDuracion()));
        int idxTipo = "Serie".equalsIgnoreCase(c.getTipo()) ? 1 : 0; // [0]=Película, [1]=Serie
        ...
        // Cambia visibilidad al cambiar el tipo
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        View cardRoot;
        TextView titulo, subtitulo, estado, fechas; // <-- añadimos 'fechas'
        ImageView btnFav;
        public ViewHolder(@NonNull View itemView) {
            ...
            fechas   = itemView.findViewById(R.id.textFechas); // <-- requiere este id en item_contenido.xml
